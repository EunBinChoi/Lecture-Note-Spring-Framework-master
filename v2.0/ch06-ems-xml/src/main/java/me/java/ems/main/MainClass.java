...
public class MainClass {
	...
	public static void register(GenericXmlApplicationContext ctx, String sNum, String sId, String sPw, String sName,
			int sAge, String sGender, String sMajor) {
		StudentRegisterService registerService = ctx.getBean("registerService",
				me.java.ems.service.StudentRegisterService.class);
		Student student = new Student(sNum, sId, sPw, sName, sAge, sGender, sMajor);
		registerService.register(student);
	}

	public static void modify(GenericXmlApplicationContext ctx, Student student) {
		StudentModifyService modifyService = ctx.getBean("modifyService",
				me.java.ems.service.StudentModifyService.class);
	...
	public static void delete(GenericXmlApplicationContext ctx, String num) {
		StudentDeleteService deleteService = ctx.getBean("deleteService",
				me.java.ems.service.StudentDeleteService.class);
		Student student = select(ctx, num);
		deleteService.delete(student);
		System.out.println("Student's info delete finished.");
	}

	public static Student select(GenericXmlApplicationContext ctx, String sNum) {
		System.out.println("Student [" + sNum + "]'s info");
		StudentSelectService selectService = ctx.getBean("selectService",
				me.java.ems.service.StudentSelectService.class);
	...
	public static void selectAll(GenericXmlApplicationContext ctx) {
		StudentSelectAllService selectAllService = ctx.getBean("selectAllService",
				me.java.ems.service.StudentSelectAllService.class);
