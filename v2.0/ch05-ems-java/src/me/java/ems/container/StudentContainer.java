...
// Spring 컨테이너 역할 (applicationContext.xml, AppConfig.class)
// 1) dataBaseConnectionInfoReal, dataBaseConnectionInfoDev
// 2) emsInformation
// 3) studentDao
// 4) selectAllService, selectService, registerService, modifyService, deleteService
public class StudentContainer {
	...
	public DataBaseConnectionInfo getDataBaseConnectionInfoReal() {
		return dataBaseConnectionInfoReal;
	}

	public DataBaseConnectionInfo getDataBaseConnectionInfoDev() {
