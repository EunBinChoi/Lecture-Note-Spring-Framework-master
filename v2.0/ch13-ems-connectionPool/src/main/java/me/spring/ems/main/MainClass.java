...
import me.spring.ems.config.AppConfig;
...
public class MainClass {
	...
	public static void register(AnnotationConfigApplicationContext ctx, String sNum, String sId, String sPw, String sName,
	...
	public static void modify(AnnotationConfigApplicationContext ctx, String attribute, String revisedData, String num) {
		StudentModifyService modifyService = ctx.getBean("modifyService", StudentModifyService.class);
		modifyService.modify(attribute, revisedData, num);
