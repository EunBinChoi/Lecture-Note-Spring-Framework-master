...
public class MemberControllerHandler {
	private final Logger logger = LoggerFactory.getLogger(MemberControllerHandler.class);
...
//		}
		...
		for (String previousRequestViewName : previousRequestViewNames) {
			if(previousRequestURL.split(cp + "/")[1].contains(previousRequestViewName)) {
