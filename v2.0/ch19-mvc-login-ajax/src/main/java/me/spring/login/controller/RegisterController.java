...
//	}
	...
	public String doLogin(@Valid @ModelAttribute RegisterDTO registerDTO, HttpSession session, Model model) 
...
//		}
	...
	public String checkIdPwd(@Valid @RequestBody RegisterDTO register) throws SQLException, DataAccessException { 
		...
		if(register.getId() == null || register.getId().equals("") ) return "blank";
		if(register.getCurpwd() == null || register.getCurpwd().equals("")) return "blank";
