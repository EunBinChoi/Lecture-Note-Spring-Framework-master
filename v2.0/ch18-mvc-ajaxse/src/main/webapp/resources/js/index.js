...
function registerFunction() { // 비동기 통신 함수
	...
	const url = "./register";
	const registerNameValue   = $("#registerName").val();
	const registerAgeValue    = $("#registerAge").val();
	const registerGenderValue = $("input[name=registerGender]:checked").val();
	const registerEmailValue  = $("#registerEmail").val();	
	const queryString = "userName=" + encodeURIComponent(registerNameValue)
		+ "&userAge=" + encodeURIComponent(parseInt(registerAgeValue))
		+ "&userGender=" + encodeURIComponent(registerGenderValue)
		+ "&userEmail=" + encodeURIComponent(registerEmailValue);
		
	const queryStringJson = {"userName" : registerNameValue,
							"userAge"   : parseInt(registerAgeValue),
							"userGender": registerGenderValue,
