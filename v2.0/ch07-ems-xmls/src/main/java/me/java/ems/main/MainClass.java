...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		GenericXmlApplicationContext ctx
			= new GenericXmlApplicationContext(
					new String[]{"applicationContext1.xml", "applicationContext2.xml", "applicationContext3.xml"});
		//GenericXmlApplicationContext ctx = new GenericXmlApplicationContext("applicationContextImport.xml");
	...
	public static void register(GenericXmlApplicationContext ctx, String sNum, String sId, String sPw, String sName, int sAge, String sGender, String sMajor) {
