...
//	}
	...
	public String doLogin(@ModelAttribute RegisterDTO registerDTO, HttpSession session, Model model) 
	...
	public String doSignup(@ModelAttribute RegisterDTO registerDTO, HttpSession session) 
			throws SQLException, DataAccessException {
		System.out.println(registerDTO);
	...
	public String doUpdate(@ModelAttribute RegisterDTO registerDTO, HttpSession session) 
			throws SQLException, DataAccessException {
		System.out.println(registerDTO);
