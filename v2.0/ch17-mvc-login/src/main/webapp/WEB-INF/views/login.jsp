...
<body>
	...
	<form id="tries" name="tries" method="post" action="${cp}/signup" style="display: none">
	...
	<form id="login" name="login" method="post" action="${cp}/doLogin">
		...
		<input type="text" id="loginId" name="id" maxlength="20" autocomplete="off"><br/>
		<label for="curpwd">PASSWORD: </label> 
		<input type="password" id="loginCurpwd" name="curpwd" maxlength="20" autocomplete="off"><br/>
