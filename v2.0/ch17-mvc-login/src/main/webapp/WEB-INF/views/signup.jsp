...
<h2>SIGN UP</h2>
    <form id="signup" name="signup" method="post" action="${cp}/doSignup">
        ...
        <input type="text" id="id" name="id" value="<%= loginFailId %>" maxlength="20" autocomplete="off"><br/>
        <label for="curpwd">PASSWORD: </label>
        <input type="password" id="curpwd" name="curpwd" value="<%= loginFailPwd %>" maxlength="20" autocomplete="off"><br/>
        <label for="currepwd">REWRITE PASSWORD: </label>
        <input type="password" id="currepwd" name="currepwd" maxlength="20" autocomplete="off"><br/>
